    ...
    <main className="detail-page">
      ...
      <section className="detail-hero">
        ...
        <div className="detail-meta-row">
          ...
          {project.featured && (
            <>
              <span className="detail-meta-sep">/</span>
              <span className="detail-featured-badge">{t("project.featured")}</span>
            </>
          )}
        </div>
        ...
        <div className="detail-info-grid">
          <div className="detail-info-item">
            <span className="detail-info-label">{t("project.info.client")}</span>
            <span className="detail-info-value">{project.client}</span>
          </div>
          <div className="detail-info-item">
            <span className="detail-info-label">{t("project.info.role")}</span>
            <span className="detail-info-value">{project.role}</span>
          </div>
          <div className="detail-info-item">
            <span className="detail-info-label">{t("project.info.duration")}</span>
            <span className="detail-info-value">{project.duration}</span>
          </div>
          <div className="detail-info-item">
            <span className="detail-info-label">{t("project.info.team")}</span>
      ...
      <section className="detail-content">
        <div className="detail-text-block">
          <span className="detail-section-title">{t("project.challenge")}</span>
          <p>{project.problem}</p>
        </div>
        <div className="detail-text-block">
          <span className="detail-section-title">{t("project.solution")}</span>
      ...
      <section className="detail-gallery">
        <span className="detail-section-title">{t("project.gallery")}</span>
      ...
      <section className="detail-content">
        <div className="detail-two-col">
          <div>
            <span className="detail-section-title">{t("project.features")}</span>
      ...
      {/* Challenges */}
      <section className="detail-content">
        <span className="detail-section-title">{t("project.challenges")}</span>
      ...
      {/* Outcomes */}
      <section className="detail-content">
        <span className="detail-section-title">{t("project.outcomes")}</span>
        ...
        <>
          ...
          <section className="detail-content">
            <div className="detail-two-col">
              {project.designProcess && project.designProcess.length > 0 && (
                <div>
                  <span className="detail-section-title">{t("project.designProcess")}</span>
              ...
              {project.lessonsLearned && project.lessonsLearned.length > 0 && (
                <div>
                  <span className="detail-section-title">{t("project.lessonsLearned")}</span>
