                ...
                <div className="mx-auto max-w-md lg:mx-0 lg:ml-auto">
                    <div className="mb-4 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            <label className="flex cursor-pointer items-center gap-1.5">
                                ...
                                />
                                <span
                                    className={`flex h-6 w-6 items-center justify-center rounded-full border-2 bg-black transition-all ${cardVariant === "dark"
                            ...
                            <label className="flex cursor-pointer items-center gap-1.5">
                                ...
                                />
                                <span
                                    className={`flex h-6 w-6 items-center justify-center rounded-full border-2 bg-white transition-all ${cardVariant === "light"
                                            ? "border-primary ring-2 ring-primary/30"
                                            : "border-border"
                                        }`}
                                >
                    ...
                    <div className="flex gap-2">
                        <div className="relative flex-1">
                            ...
                            />
                            <span
                                className={`absolute right-3 top-1/2 -translate-y-1/2 font-mono text-xs transition-colors ${isAtLimit
                                        ? "text-destructive"
                                        : isNearLimit
                                            ? "text-amber-500"
