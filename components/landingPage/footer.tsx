                ...
                <div className="footer-grid">
                    ...
                    <div className="footer-content">
                        <nav className="footer-nav">
                            <Link href="/" onClick={(e) => handleNavClick(e, "about")}>{t("foot.about")}</Link>
                            <Link href="/work">{t("foot.work")}</Link>
                            <Link href="/#certificates" onClick={(e) => handleNavClick(e, "certificates")}>{t("foot.certifications")}</Link>
                            <Link href="/blog">{t("foot.blog")}</Link>
                            <Link href="/#testimonials" onClick={(e) => handleNavClick(e, "testimonials")}>{t("foot.testimonials")}</Link>
                            <Link href="/#contact" onClick={(e) => handleNavClick(e, "contact")}>{t("foot.contact")}</Link>
                        </nav>
