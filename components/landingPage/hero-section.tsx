                        ...
                        <div className="hero-content-wrapper">
                            ...
                            <div className="hero-content">
                                ...
                                <div className="hero-social-links">
                                    ...
                                    <a href="/cv.pdf" download="CV_Azizi_E_M.pdf" aria-label="Download CV" className="inline-flex items-center gap-2 px-4 py-2 !bg-black hover:!bg-gray-900 !rounded-full text-sm font-medium text-white transition-all cursor-pointer">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
